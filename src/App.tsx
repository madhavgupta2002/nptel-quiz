...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-100 to-purple-100 py-6 sm:py-12 px-2 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-3xl sm:text-4xl font-bold text-center mb-8 sm:mb-12 text-indigo-900">WildLife Ecology</h1>
      ...
      <div className="fixed bottom-0 right-0 p-4 bg-white border-2 border-blue-600 rounded-lg shadow-lg">
        <a href="https://www.linkedin.com/in/madhavgupta2002" target="_blank" rel="noopener noreferrer" className="text-blue-600 font-bold text-sm sm:text-lg hover:underline">
