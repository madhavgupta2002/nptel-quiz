...
const QuizQuestion: React.FC<QuizQuestionProps> = ({
  ...
  return (
    <div className="w-full max-w-3xl mx-auto">
      <h2 className="text-2xl font-bold mb-6 text-indigo-900 whitespace-pre-line">
      ...
      {showResult && (
        <div className="mt-6 p-4 bg-blue-100 rounded-lg">
          ...
          <p className="text-blue-700 whitespace-pre-line">{formatText(question.explanation)}</p>
        </div>
      )}
    </div>
  );
